                ...
                <hr>
                 ...
                 <?php $select_all_sections = $this->section_model->selectSections();
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_type_name_by_id('class', $section['teacher_id']);?></td>
                            <td>
                            ...
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/section/delete/<?php echo $section['section_id'];?>')"><button class="btn btn-danger btn-rounded btn-sm"><?php echo get_phrase('Delete');?></button></a>                            </td>
                        </tr>
                        <?php endforeach;?>
